...
> **Alpha · v0.2.2-alpha** — APIs / file format / settings may still change before v1. Feedback welcome via issues.
...
| Platform | File |
|---|---|
| macOS (Apple Silicon) | `mddiff_0.2.2_aarch64.dmg` |
| macOS (Intel) | `mddiff_0.2.2_x64.dmg` |
| Windows | `mddiff_0.2.2_x64-setup.msi` |
| Linux | `mddiff_0.2.2_amd64.AppImage` |
| TUI (any platform) | `mddiff-tui_0.2.2_<target>` |
